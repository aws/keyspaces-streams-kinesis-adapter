...
public class TestUtils {
     ...
     * @return A configured Keyspaces Shard object
     */
    ...
    /**
     * Creates a Keyspaces stream shard with custom hash key range.
     *
     * @param shardId       The ID of the shard
    ...
    /**
     * Creates a closed Keyspaces shard (with ending sequence number).
     *
     * @param shardId       The ID of the shard
     * @param parentShardId The parent shard ID
     * @param startSeq      The starting sequence number
     ...
     */
    public static software.amazon.awssdk.services.keyspacesstreams.model.Shard createKeyspacesShard(
            String shardId,
            String parentShardId,
            String startSeq,
            String endSeq) {
        return software.amazon.awssdk.services.keyspacesstreams.model.Shard.builder()
                .shardId(shardId)
                .parentShardIds(Collections.singleton(parentShardId))
                .sequenceNumberRange(
     ...
     * @return A Keyspaces Shard object
     */
    ...
    public static software.amazon.awssdk.services.keyspacesstreams.model.Shard findKeyspacesShardById(
            List<software.amazon.awssdk.services.keyspacesstreams.model.Shard> shards,
            String shardId) {
        return shards.stream()
                .filter(s -> s.shardId().equals(shardId))
                .findFirst()
    ...
    public static AwsServiceException createThrottlingException() {
        return AwsServiceException.builder()
                ...
                .awsErrorDetails(AwsErrorDetails.builder()
                        .errorCode(AmazonServiceExceptionTransformer.KEYSPACES_STREAMS_THROTTLING_EXCEPTION_ERROR_CODE)
