...
import software.amazon.keyspaces.streamsadapter.KeyspacesStreamsShardDetector;
import software.amazon.keyspaces.streamsadapter.KeyspacesStreamsShardSyncer;
...
class KeyspacesStreamsShutdownTaskTest {
    ...
    private KeyspacesStreamsShutdownTask task;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        metricsFactory = new NullMetricsFactory();
        streamIdentifier = StreamIdentifier.singleStreamInstance(STREAM_ARN);
