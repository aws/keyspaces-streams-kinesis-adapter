...
public class KeyspacesStreamsSleepTimeControllerTest {

    private KeyspacesStreamsSleepTimeController controller;
    private static final long IDLE_MILLIS = 1000L;

    @BeforeEach
    public void setup() {
        controller = new KeyspacesStreamsSleepTimeController();
    }
    @Test
