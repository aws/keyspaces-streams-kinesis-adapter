...
class KeyspacesStreamsLeaseManagementFactoryTest {
    ...
    private KeyspacesStreamsLeaseManagementFactory factory;
    private static final String STREAM_ARN = "arn:aws:cassandra:us-west-2:123456789012:/keyspace/TestKeyspace/table/TestTable/stream/2024-02-03T00:00:00.000";
    ...
    void setup() {
        ...
        factory = new KeyspacesStreamsLeaseManagementFactory(
    ...
    void testCreateShardDetector() {
        ...
        assertTrue(detector instanceof KeyspacesStreamsShardDetector);
    }
    ...
    void testMultiStreamMode() {
        ...
        StreamIdentifier streamIdentifier = StreamIdentifier.multiStreamInstance(
                String.format("%s:%s:1", "123456789012", "123456789012")
        );
        when(streamConfig.streamIdentifier()).thenReturn(streamIdentifier);
        when(streamConfig.initialPositionInStreamExtended()).thenReturn(
                InitialPositionInStreamExtended.newInitialPosition(InitialPositionInStream.TRIM_HORIZON)
    ...
    void testNoOpLeaseCleanupManager() throws Exception {
        ...
        Class<?> noOpLeaseCleanupManagerClass = Class.forName(
                "software.amazon.keyspaces.streamsadapter.KeyspacesStreamsLeaseManagementFactory$NoOpLeaseCleanupManager");
