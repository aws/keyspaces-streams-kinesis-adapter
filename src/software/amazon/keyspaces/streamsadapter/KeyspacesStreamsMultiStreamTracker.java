...
public class KeyspacesStreamsMultiStreamTracker implements MultiStreamTracker {
    ...
    public KeyspacesStreamsMultiStreamTracker(List<StreamConfig> streamConfigList,
