...
package software.amazon.keyspaces.streamsadapter.model;
...
@EqualsAndHashCode
@ToString
public class KeyspacesStreamsProcessRecordsInput {
    /**
    ...
    /**
     * The records received from Keyspaces Streams.
     */
    private List<KeyspacesStreamsClientRecord> records;
    ...
    /**
     * How far behind this batch of records was when received from Keyspaces Streams.
     *
