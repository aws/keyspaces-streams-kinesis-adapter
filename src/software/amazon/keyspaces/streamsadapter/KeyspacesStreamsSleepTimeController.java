...
public class KeyspacesStreamsSleepTimeController implements SleepTimeController {
    @Override
    public long getSleepTimeMillis(SleepTimeControllerConfig sleepTimeControllerConfig) {
        ...
        long sleepTime = lastGetRecordsReturnedRecordsCount > 0 ?
                idleMillsBetweenCalls : 2 * idleMillsBetweenCalls;
