...
/**
 * Utility class for managing Keyspaces stream shard relationships and states.
 * Handles parent-child relationships and shard state transitions(i.e closing Open Parent , Opening Leaf Nodes for Disabled Streams)
 * for stream processing.
 *  Note: This class is NOT thread-safe by itself. Thread safety should be
 *  handled by the calling context (e.g., KeyspacesStreamsShardDetector's
